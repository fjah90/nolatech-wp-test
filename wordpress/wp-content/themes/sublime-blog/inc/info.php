...
function sublime_blog_customize_register_info( $wp_customize ) {
    ...
    $theme_info = '';
    $theme_info .= '<span class="sticky_info_row"><span class="emoji dashicons emoji dashicons-visibility"></span><a href="' . esc_url( 'https://sublimetheme.com/theme/sublime-blog/' ) . '"  target="_blank">' . __( 'View demo', 'sublime-blog' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><span class="emoji dashicons emoji dashicons-text-page"></span><a href="' . esc_url( 'https://sublimetheme.com/docs/sublime-blog/' ) . '" target="_blank">' . __( 'View documentation', 'sublime-blog' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><span class="emoji dashicons emoji dashicons-info"></span><a href="' . esc_url( 'https://sublimetheme.com/theme/sublime-blog/' ) . '" target="_blank">' . __( 'Theme info', 'sublime-blog' ) . '</a></span><br />';
