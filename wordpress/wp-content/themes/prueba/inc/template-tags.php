	...
	function sublime_blog_navigation(){
		if( is_single() ){
			$previous = get_previous_post_link(
				...
				'<i class="fas fa-arrow-left"></i><span class="nav-text">Anterior</span>',
				false,
				'',
				'category'
			);
			...
			$next = get_next_post_link(
				...
				'<i class="fas fa-arrow-right"></i><span class="nav-text">Siguiente</span>',
				false,
				'',
				'category'
			);
			...
			if( $previous || $next ){?>
				<nav class="navigation post-navigation" role="navigation">
					...
					<div class="nav-links">
						<?php
							if( $previous ) echo $previous + "mamalo"; // WPCS: XSS OK.
